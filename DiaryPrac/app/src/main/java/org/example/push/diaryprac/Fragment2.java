...
public class Fragment2 extends Fragment {
    ...
    private void initUI(ViewGroup rootView){
        ...
        final Button saveBtn = rootView.findViewById(R.id.saveButton);
        saveBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(mMode == AppConstants.MODE_INSERT){ //새로 작성
                    saveNote();
        ...
        Button closeBtn = rootView.findViewById(R.id.closeButton);
        ...
        sliderView.setOnSlideListener(new RangeSliderView.OnSlideListener() {
            ...
            public void onSlide(int index) {
                Toast.makeText(context, "moodIndex changed to " + index,
    ...
    public void showPhotoCaptureActivity(){
        ...
        Uri fileUri = FileProvider.getUriForFile(context,"org.example.push.diaryprac.fileprovider",file);
        ...
        if(data != null){
            switch (requestCode){
                case AppConstants.REQ_PHOTO_CAPTURE: // 사진 찍는 경우
                    ...
                    resultPhotoBitmap = decodeSampledBitmapFromResource(file,pictureImageView.getWidth(),
