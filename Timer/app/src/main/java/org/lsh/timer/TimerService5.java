...
public class TimerService5 extends Service {
    private static final String TAG = "Service5";
    ...
    public TimerService5() {
    }

    IMyTimerService5.Stub binder = new IMyTimerService5.Stub() {
        @Override
    ...
    public void showNoti2(String text) {
